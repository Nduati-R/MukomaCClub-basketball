...
import { Target, Eye, Trophy, Users, Shield, Heart } from "lucide-react";
...
const values = [
  ...
  { icon: Shield, title: "Integrity", desc: "We operate with honesty, fairness, and transparency." },
  { icon: Heart, title: "Inclusion", desc: "Everyone deserves access to great sport and great facilities." },
];

const team = [
  { name: "James Otieno", role: "Club Chairman", img: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400&q=80", bio: "Two decades of leadership in Kenyan sports." },
  { name: "Grace Wambui", role: "Director of Sports", img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&q=80", bio: "Former national tennis champion turned mentor." },
  { name: "Brian Kiptoo", role: "Head Coach", img: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&q=80", bio: "UEFA-licensed coach developing elite talent." },
  { name: "Linet Achieng", role: "Facilities Manager", img: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&q=80", bio: "Ensures every facility runs at world-class standards." },
];
      ...
      <div ref={ref} className={`container mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${className}`}>
        <div>
          ...
          <div className="space-y-4 text-muted-foreground text-lg">
            <p>Founded in 2004, the Country Club & Sports Academy has grown from a modest community initiative into Kenya's leading integrated sports and leisure destination.</p>
            <p>We believe sport has the power to shape character, build community, and unlock potential at every age.</p>
            <p>From our world-class facilities to our structured academy programs, everything we do is in service of that mission.</p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          <Card className="p-10 border-t-4 border-t-gold rounded-sm">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              To provide world-class sports facilities and academy programs that inspire excellence, build character, and unite our community.
            </p>
          </Card>
          <Card className="p-10 border-t-4 border-t-gold rounded-sm">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              To be East Africa's most respected sports and leisure destination, known for cultivating champions in sport and in life.
            </p>
          </Card>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-[60vh] min-h-[420px] flex items-end overflow-hidden">
        ...
        <div className="container mx-auto px-6 pb-16 relative text-background">
          ...
          <h1 className="font-display text-5xl md:text-7xl font-semibold leading-tight max-w-3xl">About Us</h1>
          <p className="mt-4 text-lg md:text-xl text-background/85 max-w-2xl">
            A legacy of sport, community, and excellence since 2004.
          </p>
        </div>
      </section>
      <Story />
